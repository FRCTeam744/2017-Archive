...
public final class MotorSafetyHelper {
  ...
  public void check() {
    ...
    if (m_stopTime < Timer.getFPGATimestamp()) {
      String msg = m_safeObject.getDescription() + "... Output not updated often enough.";
      DriverStation.reportError(m_safeObject.getDescription() + "... Output not updated often "
          + "enough (m_stopTime=" + m_stopTime + ", FPGAtime=" + Timer.getFPGATimestamp() + ").", false);

      m_safeObject.stopMotor();
      throw TmExceptions.getInstance().new MotorSafetyTimeoutEx(msg);
    }
  }
