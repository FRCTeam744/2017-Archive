...
//	private static final double SPIN_SPEED = 1.0;
    ...
    public TmACGrpCenterGearAndShootBlue() {
        // Add Commands here:
    	...
    	addSequential(new TmACmdDriveSpinGyro(DriveSpinDirectionE.CLOCKWISE, 70)); //63));  //adjust turn value
    	addSequential(new TmCCmdDelay(0.05));
    	addSequential(new TmACmdDriveStraightEndWithGyro( -9.9, 7.0));  //adjust drive value based on turn value
    	addSequential(new TmCCmdDelay(0.05));
