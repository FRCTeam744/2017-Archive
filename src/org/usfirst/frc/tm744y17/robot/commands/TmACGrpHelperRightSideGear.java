 ...
 */
public class TmACGrpHelperRightSideGear extends CommandGroup { //was TmACGrpHelperRightSideGearRed
...
//	private static final double BACK_AWAY_SPEED = -0.5;
    ...
    public TmACGrpHelperRightSideGear() { //was: TmACGrpHelperRightSideGearRed
...
//    	addSequential(new TmCCmdDriveShiftGear(TmSsDrvGearShift.DrvGearsE.LOW));
    	addSequential(new TmACmdDriveStraightEndWithGyro(7.66333+0.25+0.25-(3.5/12.0), 6)); //+7.83, 6)); //+0.25
        addSequential(new TmCCmdDelay(0.05));
