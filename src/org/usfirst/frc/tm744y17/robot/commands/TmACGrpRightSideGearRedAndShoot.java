 ...
 */
public class TmACGrpRightSideGearRedAndShoot extends CommandGroup {
...
//	private static final double BACK_AWAY_SPEED = -1.0;
    public TmACGrpRightSideGearRedAndShoot() {
...
//        addSequential(new TmCCmdDelay(0.5));
        ...
        addSequential(new TmCCmdDelay(0.05));
        addSequential(new TmACmdDriveSpinGyro(DriveSpinDirectionE.CLOCKWISE, 17)); //30)); //20));
        addSequential(new TmCCmdDelay(0.05));
        addSequential(new TmACmdDriveStraightEndWithGyro(-4.458, 2)); //(-5.458,2));
        addSequential(new TmCCmdDelay(0.05));
