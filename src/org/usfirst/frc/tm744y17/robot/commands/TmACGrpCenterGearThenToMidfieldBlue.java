 ...
 *
 */
//public class TmACGrpCenterGearAndShootBlue extends CommandGroup {
public class TmACGrpCenterGearThenToMidfieldBlue extends CommandGroup {
...
//	private static final double SPIN_SPEED = 1.0;
    ...
    public TmACGrpCenterGearThenToMidfieldBlue() {
        // Add Commands here:
    	...
    	addSequential(new TmACmdDriveStraightEndWithGyro(-0.5)); //TmCCmdDriveForwardDistance(REVERSE_SPEED, REVERSE_SPEED,-.5, 0.20));
    	addSequential(new TmCCmdDelay(.05));
