 ...
 *
 */
public class TmTCmdDriveSetDirectionForward extends Command {
	
	TmSsDriveTrain ssDrive;

    public TmTCmdDriveSetDirectionForward() {
...
//    	requires(ssDrive);
    ...
    protected void initialize() {
    	ssDrive.setDriveDirection(DriveTrainDirectionE.FORWARD__GEAR_PLACER_LEADS);
    }
